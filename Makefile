...
BUILD_DIR := build
CORE_SOURCES := src/diagnostic.cpp src/ast.cpp src/lexer.cpp src/parser.cpp src/symbol_table.cpp src/semantic_analyzer.cpp src/cost_analyzer.cpp src/ir.cpp src/certificate.cpp src/interpreter.cpp
