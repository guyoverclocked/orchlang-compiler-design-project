...
TokenKind keywordKind(const std::string& value) {
    ...
    if (value == "untrusted") return TokenKind::Untrusted;
    if (value == "tool") return TokenKind::Tool;
    if (value == "emit") return TokenKind::Emit;
    if (value == "if") return TokenKind::If;
    if (value == "else") return TokenKind::Else;
    if (value == "retry") return TokenKind::Retry;
    if (value == "declassify") return TokenKind::Declassify;
    if (value == "endorse") return TokenKind::Endorse;
    if (value == "as") return TokenKind::As;
    if (value == "because") return TokenKind::Because;
    if (value == "cost_per_token") return TokenKind::CostPerToken;
...
const char* tokenKindName(TokenKind kind) {
    switch (kind) {
        ...
        case TokenKind::Untrusted: return "UNTRUSTED";
        case TokenKind::Tool: return "TOOL";
        case TokenKind::Emit: return "EMIT";
        case TokenKind::If: return "IF";
        case TokenKind::Else: return "ELSE";
        case TokenKind::Retry: return "RETRY";
        case TokenKind::Declassify: return "DECLASSIFY";
        case TokenKind::Endorse: return "ENDORSE";
        case TokenKind::As: return "AS";
        case TokenKind::Because: return "BECAUSE";
        case TokenKind::CostPerToken: return "COST_PER_TOKEN";
